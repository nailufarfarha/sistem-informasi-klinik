  ...
  return (
    <div className="body">
      ...
      <div className="tentang">
        ...
        <h2 className="text-orange">Visi</h2>
        <span>“Menjadikan Fatimah Medical Clinic solusi kesehatan masyarakat.”</span>
        <h2 className="text-orange">Misi</h2>
        <span>
        ...
        <h2 className="text-orange">Tujuan</h2>
        <span>
        ...
        <h2 className="text-orange">Motto</h2>
        <span>“SENYUM PASIEN SEGALANYA BAGI KAMI”</span>
      </div>
      <Footer></Footer>
    </div>
  );
